...
export const AssemblerDashboard: React.FC<AssemblerDashboardProps> = ({ onLogout }) => {
  ...
  const renderHomeSection = () => (
    <>
      ...
      <Tabs value={activeTab} onValueChange={(value) => setActiveTab(value as 'available' | 'in-progress' | 'completed' | 'profile')} className="mt-4">
        ...
        <TabsContent value="profile">
          <div className="space-y-6 mt-4">
            {isLoadingProfile ? (
              ...
              <>
                {/* Informações Básicas */}
                <div className="dashboard-card bg-white rounded-xl shadow-md">
                  <div className="p-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div>
                        ...
                        <p className="text-gray-900">{assemblerProfile.name}</p>
                      </div>
                      <div>
                        <label className="text-sm font-medium text-gray-600">Email</label>
                        <p className="text-gray-900">{assemblerProfile.email}</p>
                      </div>
                      <div>
                        <label className="text-sm font-medium text-gray-600">Telefone</label>
                        <p className="text-gray-900">{assemblerProfile.phone}</p>
                      </div>
                      <div>
                        <label className="text-sm font-medium text-gray-600">Tipo de Usuário</label>
                        <p className="text-gray-900 capitalize">{assemblerProfile.userType}</p>
                      </div>
                    </div>
                  </div>
                </div>

                {/* Informações Profissionais do Montador */}
                {assemblerProfile.assembler && (
                  <>
                    <div className="dashboard-card bg-white rounded-xl shadow-md">
                      <div className="p-6">
                        <h3 className="text-lg font-semibold text-gray-900 mb-4 flex items-center">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                          <div>
                            ...
                            <p className="text-gray-900">{assemblerProfile.assembler.city}</p>
                          </div>
                          <div>
                            <label className="text-sm font-medium text-gray-600">Estado</label>
                            <p className="text-gray-900">{assemblerProfile.assembler.state}</p>
                          </div>
                          <div>
                            <label className="text-sm font-medium text-gray-600">Raio de Atendimento</label>
                            <p className="text-gray-900">{assemblerProfile.assembler.workRadius} km</p>
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="dashboard-card bg-white rounded-xl shadow-md">
                      <div className="p-6">
                        ...
                        <div className="space-y-4">
                          {assemblerProfile.assembler.experienceYears && (
                            <div>
                              <label className="text-sm font-medium text-gray-600">Anos de Experiência</label>
                              <p className="text-gray-900">{assemblerProfile.assembler.experienceYears} anos</p>
                            </div>
                          )}
                          
                          {assemblerProfile.assembler.professionalDescription && (
                            <div>
                              <label className="text-sm font-medium text-gray-600">Descrição Profissional</label>
                          ...
                          {assemblerProfile.assembler.experience && (
                            <div>
                              <label className="text-sm font-medium text-gray-600">Experiência Detalhada</label>
                              <p className="text-gray-900 whitespace-pre-wrap">
                                {assemblerProfile.assembler.experience}
                              </p>
                            </div>
                    ...
                    <div className="dashboard-card bg-white rounded-xl shadow-md">
                      <div className="p-6">
                        ...
                        <div className="flex flex-wrap gap-2">
                          {assemblerProfile.assembler.specialties?.map((specialty, index) => (
                            <span 
                              key={index}
                    ...
                    {assemblerProfile.assembler.serviceTypes && assemblerProfile.assembler.serviceTypes.length > 0 && (
                      <div className="dashboard-card bg-white rounded-xl shadow-md">
                        <div className="p-6">
                          <h3 className="text-lg font-semibold text-gray-900 mb-4">
                          ...
                          <div className="flex flex-wrap gap-2">
                            {assemblerProfile.assembler.serviceTypes.map((type, index) => (
                              <span 
                                key={index}
                    ...
                    {assemblerProfile.assembler.availability && (
                      <div className="dashboard-card bg-white rounded-xl shadow-md">
                        <div className="p-6">
                          <h3 className="text-lg font-semibold text-gray-900 mb-4">
                            Disponibilidade
                          ...
                          <div className="space-y-3">
                            <div>
                              ...
                              <div className="flex flex-wrap gap-2 mt-2">
                                {assemblerProfile.assembler.availability.dias?.map((dia, index) => (
                                  <span 
                                    key={index}
                            ...
                            {assemblerProfile.assembler.availability.horarios && (
                              <div>
                                <label className="text-sm font-medium text-gray-600">Horário de Trabalho</label>
                                <p className="text-gray-900">
                                  {assemblerProfile.assembler.availability.horarios.inicio} às {assemblerProfile.assembler.availability.horarios.fim}
                                </p>
                              </div>
                            )}
                          </div>
                        ...
                        <div className="space-y-3">
                          <div className="flex items-center">
                            <span className={`inline-flex items-center px-3 py-1 rounded-full text-sm font-medium ${
                              assemblerProfile.assembler.hasOwnTools 
                                ? 'bg-green-100 text-green-800' 
                                : 'bg-gray-100 text-gray-800'
                            }`}>
                              {assemblerProfile.assembler.hasOwnTools ? 'Possui ferramentas próprias' : 'Não possui ferramentas próprias'}
                            </span>
                          </div>
                          
                          {assemblerProfile.assembler.technicalAssistance && (
                            <div className="flex items-center">
                      ...
                      <div className="p-6">
                        ...
                        <div className="flex items-center">
                          <div className="flex items-center text-yellow-500">
                            {[1, 2, 3, 4, 5].map((star) => (
                              <Star
                                key={star}
                                className={`h-5 w-5 ${
                                  star <= (assemblerProfile.assembler?.rating || 0)
                                    ? 'text-yellow-500 fill-yellow-500'
                                    : 'text-gray-300'
                                }`}
                              />
                          ...
                          <span className="text-lg font-semibold text-gray-900 ml-3">
                            {assemblerProfile.assembler?.rating ? assemblerProfile.assembler.rating.toFixed(1) : '0.0'}
                          </span>
              ...
              <div className="dashboard-card bg-white rounded-xl shadow-md p-6 text-center">
